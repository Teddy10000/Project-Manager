export const API_URLS = 'http://localhost:8000/api/'
export const ACCOUNTS_API_URL = "http://localhost:8000/api/accounts/";
export const REGISTRATION_URL = "http://localhost:8000/account/api/auth/registration/"
...
export const PROJECT_TASKLIST_URL = "http://localhost:8000/manager/api/project-list/"
